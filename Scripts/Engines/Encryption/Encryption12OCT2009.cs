        ...
        public void DecodeIncomingPacket(NetState from, ref byte[] buffer, ref int length)
        {
            ...
            if (m_Encryption != null)
            {
                ...
                if (m_AlreadyRelayed && m_Encryption is LoginEncryption)
                {
                    ...
                    ///IClientEncryption newEncryption = new OldGameEncryption(newSeed, 0x383477BC, 0x02345CC6);
            ...
            if (m_Encryption == null)
            {
                ...
                if (packetLength == 62)
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("m_Seed: {0}, buffer: {1}, packetOffset: {2}, packetLength: {3}", m_Seed, buffer, packetOffset, packetLength);
                ...
                else if (packetLength == 65)
                {
                    ...
                    else
                    {
                        ...
                        m_Encryption = new OldGameEncryption(m_Seed, 0x383477BC, 0x02345CC6);
