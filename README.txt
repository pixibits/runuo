Note:  Source pulled from RunUO Github repo at the closest commit I could find that fit the included diff patch and the scripts (commit 18d13966).   
The diff file described in this readme has been applied and VS sln/proj files set up.  Committing the original packaged saves.   I'm just doing this for my
own personal use, huge thanks to Zippy for making all this work available.
